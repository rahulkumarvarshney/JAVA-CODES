...
public class em {
    ...
    public static void main(String[] args) {
        ...
        employee e2 = new employee("John Doe"); // Constructor with name parameter
        employee e3 = new employee("Jane Smith", 50000.0); // Constructor with name and salary parameters
